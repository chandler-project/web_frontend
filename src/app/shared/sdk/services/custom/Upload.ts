...
export class UploadApi extends BaseLoopBackApi {
  ...
  /**
   * Support more types of to-be-uploaded file
   *
   * @param {object} data Request data.
   *
   *  - `req` – `{object}` -
   ...
   *  - `result` – `{object}` -
   */
  public uploadAll(req: any = {}, res: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = 'POST';
    let _url: string = LoopBackConfig.getPath() + '/' + LoopBackConfig.getApiVersion() +
      '/Uploads/upload';
    let _routeParams: any = {};
   ...
   * </em>
   */
  public uploadURL(data: any, customHeaders?: Function): Observable<any> {
    let _method: string = 'POST';
    let _url: string = LoopBackConfig.getPath() + '/' + LoopBackConfig.getApiVersion() +
      '/Uploads/uploadURL';
    let _routeParams: any = {};
