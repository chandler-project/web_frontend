...
export class CategoryApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public getDeals(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
   ...
   * </em>
   */
  public getRequests(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
   ...
   * </em>
   */
  public createRequests(id: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Categories/:id/requests";
    let _routeParams: any = {
   ...
   * </em>
   */
  public createManyRequests(id: any, data: any[] = [], customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Categories/:id/requests";
    let _routeParams: any = {
